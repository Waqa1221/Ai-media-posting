...
const PLATFORMS = [
  { id: 'instagram', name: 'Instagram', icon: '📸', color: 'bg-pink-100 text-pink-800' },
  { id: 'linkedin', name: 'LinkedIn', icon: '💼', color: 'bg-blue-100 text-blue-800' },
  { id: 'twitter', name: 'Twitter/X', icon: '🐦', color: 'bg-gray-100 text-gray-800' },
  { id: 'facebook', name: 'Facebook', icon: '📘', color: 'bg-blue-100 text-blue-800' },
  { id: 'tiktok', name: 'TikTok', icon: '🎵', color: 'bg-black text-white' }
]

export function PostCreationWizard({ method, onComplete, onCancel }: PostCreationWizardProps) {
  ...
  const addHashtag = () => {
    if (hashtagInput.trim() && !postData.hashtags.includes(hashtagInput.trim())) {
      updatePostData({
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                  ...
                  <p className="text-gray-500">Media upload functionality coming soon</p>
                      ...
                      <Popover>
                        ...
                        <PopoverContent className="w-auto p-0" align="start">
                          <Calendar
                            ...
                            onSelect={(date) => updatePostData({ scheduledFor: date || null })}
                              ...
                              <Input
                                ...
                                onChange={(e) => {
                                  if (postData.scheduledFor) {
                                    ...
                                    const newDate = new Date(postData.scheduledFor)
                    ...
                    {postData.scheduledFor && (
                      <Alert>
                        ...
                        <AlertDescription>
                          ...
                          <strong>{format(postData.scheduledFor, 'PPP p')}</strong>
                        </AlertDescription>
                      </Alert>
                    )}
                  </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="bg-gray-50 rounded-lg p-4">
                <h4 className="font-medium mb-2">{postData.title || 'Untitled Post'}</h4>
                ...
                <div className="flex items-center justify-between text-sm text-gray-500">
                  ...
                  <div>
                    {postData.publishNow ? (
                      ...
                      `Scheduled for ${format(postData.scheduledFor, 'MMM dd, yyyy h:mm a')}`
                    ) : (
                      'Saving as draft'
                    )}
                  </div>
