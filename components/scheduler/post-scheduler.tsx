...
export function PostScheduler({
  ...
  const calculateContentScore = () => {
    ...
    const hasCallToAction =
      /\b(click|visit|check|try|download|sign up|learn more|comment|share|like)\b/i.test(
        postData.content
      );
    ...
    if (postData.platforms.length === 0) {
      ...
      postData.platforms.forEach((platformId) => {
        ...
        if (platform && postData.content.length > platform.maxLength) {
          platformErrors.push(
            `Content exceeds ${platform.name} limit (${platform.maxLength} chars)`
          );
        }
      });
    ...
    try {
      ...
      try {
        ...
        if (
          ...
          throw new Error(
            "Server returned HTML instead of JSON. This usually indicates a server error or missing API route."
          );
        }
      ...
      if (error instanceof Error) {
        if (error.message.includes("HTML instead of JSON")) {
          errorMessage =
            "Server configuration error. Please check if the database is properly set up.";
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="text-center">
                <div
                  className={`text-2xl font-bold ${getContentScoreColor(
                    contentScore
                  )}`}
                >
                  {contentScore}
                      ...
                      <ul className="text-sm space-y-1">
                        {!postData.content.includes("?") &&
                          !/\b(click|visit|check|try|download|sign up|learn more|comment|share|like)\b/i.test(
                            ...
                            <li>
                              • Add a question or call-to-action to boost
                              engagement
                            </li>
                          )}
                        {!/[\uD83C-\uDBFF\uDC00-\uDFFF]|[\u2600-\u27BF]/.test(
                        ...
                        {postData.content.length < 50 && (
                          <li>
                            • Add more detail to provide value to your audience
                          </li>
                        )}
                    ...
                    {getAvailablePlatforms().map((platform) => {
                      ...
                      return (
                        <div
                          ...
                          onClick={() =>
                            !exceedsLimit && togglePlatform(platform.id)
                          }
                        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <Popover>
                      ...
                      <PopoverContent className="w-auto p-0" align="start">
                        <Calendar
                          ...
                          onSelect={(date) =>
                            updatePostData({ scheduledDate: date || null })
                          }
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        updatePostData({ scheduledTime: e.target.value })
                      }
              ...
              onOptimize={(optimizations) => {
                ...
                if (optimizations.suggestedHashtags) {
                  ...
                  const mergedHashtags = [
                    ...postData.hashtags,
                    ...optimizations.suggestedHashtags,
                  ];
                  const uniqueHashtags = Array.from(new Set(mergedHashtags));
